...
<div class="container">
  <div class="card-panel">
      <center><b><?php echo anchor('home/tambah_pemb','Tambah Data'); ?></b></center>    
  </div>
 <div class="card-panel ">
<table class="responsive-table highlight">
    <thead>
      <tr>
      <th width="2%">No</th>
      <th width="5%">Nama Pembina/Alumni</th>
    ...
    ?>
      <tr>
        ...
        <td>
		       ...
		       <a href="<?php echo base_URL()?>index.php/home/edit_pemb/<?php echo $q->id ?>" class="btn-floating yellow btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Edit" ><i class="material-icons">edit</i></a>
		        
		        
		        <a href="<?php echo base_URL()?>index.php/home/hapus_pemb/<?php echo $q->id ?>" class="btn-floating red btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Hapus"><i class="material-icons">delete</i></a>
