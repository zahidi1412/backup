...
<div class="container">
  <div class="card-panel">
      <center><b><?php echo anchor('home/tambah_angg','Tambah Data'); ?></b></center>    
  </div>
    ...
    ?>
      <tr>
        ...
        <td>
		       ...
		       <a href="<?php echo base_URL()?>index.php/home/edit_ang/<?php echo $q->id ?>" class="btn-floating yellow btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Edit" ><i class="material-icons">edit</i></a>
		        
		        
		        <a href="<?php echo base_URL()?>index.php/home/hapus_angg/<?php echo $q->id ?>" class="btn-floating red btn tooltipped" data-position="bottom" data-delay="50" data-tooltip="Hapus"><i class="material-icons">delete</i></a>
