<div class="uk-width-expand@m">
		...
		<div class="container">
		 <div class="card-panel teal blue lighten-5">
		    <form class="col s12" action="<?php echo base_url(). 'index.php/home/update_angg'; ?>" method="post">
		      <div class="row">
		      ...
		      <div class="row">
		        ...
		        <div class="col s6">
		          ...
		          <div class="input-field inline">
		            <input type="date" class="datepicker" name="tgl_lahir" value="<?php echo $u->tgl_lahir ?>">
